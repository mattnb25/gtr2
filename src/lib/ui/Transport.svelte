    ...
    >
      ...
      <div class="option-section">
        ...
        {#if pb.isMetronomeActive}
          <div class="slider-row">
            <span class="sub-label">Volume: {Math.round(pb.metronomeVolume * 100)}%</span>
            <input
              type="range"
              min="0"
              max="1"
              ...
              oninput={(e) => pb.setMetronomeVolume(Number(e.target.value))}
            />
          </div>
        {/if}
      </div>
      ...
      <div class="option-section">
        ...
        {#if pb.isCountInActive}
          <div class="slider-row">
            <span class="sub-label">Volume: {Math.round(pb.countInVolume * 100)}%</span>
            <input
              type="range"
              min="0"
              max="1"
              ...
              oninput={(e) => pb.setCountInVolume(Number(e.target.value))}
            />
          </div>
        {/if}
      </div>
      ...
      <div class="option-section">
        <div class="option-row">
          ...
          <span class="speed-val">{Math.round(pb.playbackSpeed * 100)}%</span>
        </div>
        <div class="speed-presets">
          {#each [0.5, 0.75, 1.0, 1.25, 1.5] as speed}
            <button
              class="preset-btn"
              class:active={pb.playbackSpeed === speed}
              onclick={() => pb.setPlaybackSpeed(speed)}
            >
        ...
        <div class="slider-row">
          <input
            ...
            oninput={(e) => pb.setPlaybackSpeed(Number(e.target.value))}
          />
        </div>
      </div>
    </SplitPopoverBtn>
